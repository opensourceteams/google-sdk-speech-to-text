package com.opensourceteams.module.google.speech.to.text.simple.stream.punctuation;
...
public class RunEnglish {
    ...
    public static void main(String[] args) throws Exception {
        logger.info("开始");
        streamingTranscribeWithAutomaticPunctuation("data/wav/english/audio.raw");
        logger.info("结束");
