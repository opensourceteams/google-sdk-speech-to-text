package com.opensourceteams.module.google.speech.to.text.simple.示例.v1.n_001_短语音_flac_格式_远程文件;
...
public class Run {
    ...
    static String filePath = "gs://thinktothings.com/example/40.flac" ;
