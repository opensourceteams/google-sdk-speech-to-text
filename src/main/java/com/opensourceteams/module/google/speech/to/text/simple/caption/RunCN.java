package com.opensourceteams.module.google.speech.to.text.simple.caption;
...
public class RunCN {
    ...
    public static void main(String... args) throws Exception {
        ...
        transcribeCaption(fileName);



    }

    public static void transcribeCaption(String fileName) throws Exception {
